...
public interface CommissionService {
	...
	Page<CommissionDO> getAllCommissions(int pageNumber, int resultsPerPage) throws ServiceException;
	Page<CommissionDO> findCommissionsByName(String name, int pageNumber, int resultsPerPage) throws ServiceException;
	Commission getCommissionById(Long id) throws ServiceException;
	Page<CommissionDO> getCommissionsByType(CommissionType commissionType, int pageNumber, int resultsPerPage) throws ServiceException;
	Page<CommissionDO> getCommissionsByChamber(Chamber chamber, int pageNumber, int resultsPerPage) throws ServiceException;
	CommissionDetailedDO getCommissionDetailedDO(Long id) throws ServiceException;
