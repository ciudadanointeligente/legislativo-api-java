...
public interface LegislatorRoleService {
	...
	LegislatorDetailedDO getLegislatorDetailedDO(Long id) throws ServiceException;
	Page<LegislatorDO> getLegislatorsByPerson(Person person, int page, int perPage) throws ServiceException;
	Page<LegislatorDO> getLegislatorsByCircunscription(Circunscription circunscription, int page, int perPage) throws ServiceException;
	Page<LegislatorDO> getLegislatorsByDistrict(District district, int page, int perPage) throws ServiceException;
	Page<PersonDO> getPersonDOs(int page, int perPage) throws ServiceException;
	Page<PersonDO> getLegislatorPersonDOs(int page, int perPage) throws ServiceException;
}
