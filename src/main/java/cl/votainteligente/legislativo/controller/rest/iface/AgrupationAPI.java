...
public interface AgrupationAPI {
	 ...
	 *
	 * @param agrupationName The Agrupation name to look for.
	...
	@GET
	@Path("any")
	public Page<AgrupationDO> getByName(@PathParam("name") final String agrupationName,
			@PathParam("page") @DefaultValue("1") final int page,
			@PathParam("perPage") @DefaultValue("10") final int perPage);
	 ...
	 * @return A page of Agrupation Abstracts (AgrupationDO) <br />
	 * 			For Example:
	 * 			<a href="http://demo.ciudadanointeligente.cl/Legislativo/api/agrupation/any?person=1">agrupation/any?person=1</a>
	 */

	@GET
	@Path("any")
	public Page<AgrupationDO> getByPerson(@PathParam("id") final long personId,
			@PathParam("page") @DefaultValue("1") final int page,
			@PathParam("perPage") @DefaultValue("10") final int perPage);
	 ...
	 *
	 * @param agrupationId The Agrupation identification number.
	...
	@GET
	@Path("any")
	public AgrupationDetailedDO getById(@PathParam("id") final long agrupationId);
	 ...
	 * 			For Example:
	 * 			<a href="http://demo.ciudadanointeligente.cl/Legislativo/api/agrupation/historicalAffiliates?id=1">agrupation/historicalAffiliates?id=1</a>
	 */
	@GET
	@Path("historicalAffiliates")
	public Page<PersonDO> getHistoricalAffiliatesByAgrupation(
			@PathParam("id") final long agrupationId,
			@PathParam("page") @DefaultValue("1") final int page,
			@PathParam("perPage") @DefaultValue("10") final int perPage);
	 ...
	 * @return A Page of Person Abstracts (Person DO) <br />
	 * 			For Example:
	 * 			<a href="http://demo.ciudadanointeligente.cl/Legislativo/api/agrupation/currentAffiliates?id=1">agrupation/currentAffiliates?id=1</a>
	 */
	@GET
