...
public class Bill {
	...
	/**
	 * @param bulletinNumber the bulletinNumber to set
	 */
	...
	/**
	 * @param bCNLawId the bCNLawId to set
	 */
	public void setBCNLawId(Long bCNLawId) {
		BCNLawId = bCNLawId;
	}
	/**
	 * @param bCNLawURL the bCNLawURL to set
	 */
	...
	/**
	 * @param originChamber the originChamber to set
	 */
	...
	/**
	 * @param decree the decree to set
	 */
