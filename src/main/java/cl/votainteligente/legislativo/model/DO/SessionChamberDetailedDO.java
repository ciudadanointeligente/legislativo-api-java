...
public class SessionChamberDetailedDO {
	...
	public SessionChamberDetailedDO() {
	}

	public SessionChamberDetailedDO(SessionChamber session) {
		this.id = session.getId();
		this.number = session.getNumber();
		this.setLegislature(session.getLegislature());
		Chamber chamber = session.getChamber();
		if (chamber != null) {
			this.setChamberId(chamber.getId());
		}
